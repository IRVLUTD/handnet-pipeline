...
if __name__ == '__main__':
  ...
  if args.net == 'res34' or args.net == 'res18':
    assert 'trainval_net_fpn.py must be used for res18 and res34'
    ...
    for step in range(iters_per_epoch):
      ...
      if step % args.disp_interval == 0:
        ...
        if args.mGPUs:
          ...
          loss_hand_dxdy = 0 if type(loss_list[1][1]) is int else loss_list[1][1].mean().item()
          ...
          loss_hand_dxdy = 0 if type(loss_list[1][1]) is int else loss_list[1][1].item()
        ...
        print("\t\t\tcontact_state_loss: %.4f, dxdy_loss: %.4f, lr_loss: %.4f" % (loss_hand_state, loss_hand_dxdy, loss_hand_lr))
