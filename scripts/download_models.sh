...
wget --no-check-certificate -r "https://drive.google.com/uc?export=download&id=1JezEmWwX_xE61HasRj313ufGSL9PvqIp&confirm=t" -O "experiment/pose2mesh_manoJ_train_freihand/final.pth.tar" 
